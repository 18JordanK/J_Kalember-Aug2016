...
//Part 1:Methods, Headers, and Basic Math
	...
	public static void toMixedNum(int numerator, int denominator){
		...
		System.out.println(wholeNum + "_" + mixedNumerator + "/" + denominator);
	}
...
//Part 3:Methods that use Loops and Calls to Other Methods
	...
	*/
	...
	public static int gcf(int num1, int num2){
		int divider = 0;
		int greaterNum = Calculate.max(num1, num2);
		int gcf = 1;
		for(int i=0;i<greaterNum;i++){
			if(Calculate.isDivisbleBy(num1, divider) && Calculate.isDivisbleBy(num2, divider)){
				gcf = divider;
			}
			divider++;
		}
